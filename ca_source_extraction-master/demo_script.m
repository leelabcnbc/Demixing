...
nam = '~/Downloads/T060_1L_10252016_000_023_PLANE2_frame109.tif';          % insert path to tiff stack here
sframe=1;						% user input: first frame to read (optional, default 1)
num2read=1;					% user input: how many frames to read   (optional, default until the end)
